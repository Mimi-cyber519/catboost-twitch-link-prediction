...
|---------|----------|----------|
| **common_friends** | Количество общих друзей | **~24%** |
| **views_diff** | Разница в просмотрах | **~22%** |
| **same_comm** | В одном сообществе | **~18%** |
| **rate_diff** | Разница в PageRank | **~15%** |
| **connections_diff** | Разница в подписчиках | **~11%** |
| **common_interests** | Общие интересы (теги) | **~5%** |
| **days_diff** | Разница в возрасте аккаунта | **~3%** |
| **both_partner** | Оба партнеры Twitch | **~1%** |
| **both_mature** | Оба имеют взрослый контент | **~1%** |
