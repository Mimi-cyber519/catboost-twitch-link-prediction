...
CatBoost выбран как один из наиболее эффективных алгоритмов градиентного бустинга для табличных данных. Он устойчивый к переобучению и быстрый (8.05 сек).
